...
const Video = () => {
  return (
    <section className="video">
      ...
      <img className="video-gradient video__tl-gradient" src={TLgradient} alt="gradient" />
      <img className="video-gradient video__br-gradient" src={BRgradient} alt="gradient" />
    </section>
  );
};
